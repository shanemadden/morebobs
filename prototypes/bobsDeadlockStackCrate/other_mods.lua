...
if deadlock_stacking then
	...
	if data.raw["item"]["stone-tablet"] then 
		deadlock_stacking.create("stone-tablet", "__morebobs__/graphics/icons/stacking/stacked-stone-tablet.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["motor"] then 
		deadlock_stacking.create("motor", "__morebobs__/graphics/icons/stacking/stacked-motor.png", "deadlock-stacking-2", 32)
	end
	if data.raw["item"]["electric-motor"] then 
		deadlock_stacking.create("electric-motor", "__morebobs__/graphics/icons/stacking/stacked-electric-motor.png", "deadlock-stacking-2", 32)
	end
	if data.raw["item"]["engine-unit"] then 
		deadlock_stacking.create("engine-unit", "__morebobs__/graphics/icons/stacking/stacked-engine-unit.png", "deadlock-stacking-3", 32)
	end
	if data.raw["item"]["electric-engine-unit"] then 
		deadlock_stacking.create("electric-engine-unit", "__morebobs__/graphics/icons/stacking/stacked-electric-engine-unit.png", "deadlock-stacking-3", 32)
	end
...
if mods["DeadlockCrating"] then
	--AAI
	if data.raw["item"]["wooden-gear"] then
		deadlock_crating.create("wooden-gear", "deadlock-crating-1")
	end
	if data.raw["item"]["stone-tablet"] then 
